 ...
 */
public class SummerHeader {

    public static final short MAGIC = (short) 0xF1F1;
    private int version = 1;//rpc协议版本号。
    ...
    public static SummerHeader buildHeader(byte[] headerBytes) {
        ByteBuffer buf = ByteBuffer.wrap(headerBytes);
        short mg = buf.getShort();
        if (mg != MAGIC) {
            throw new SummerServiceException("decode summer header fail. magicnum not correct. magic:" + mg);
        }
    ...
    public boolean equals(Object o) {
        ...
        SummerHeader that = (SummerHeader) o;
