...
/**
 * FurySerialization streaming API unit tests.
 * <p>
 * Fury natively supports POJOs, records, collections, maps, and exceptions
 * without requiring {@link Serializable}.
 */
class FurySerializationTest {
    ...
    @BeforeEach
    void setUp() {
        serialization = new FurySerialization();
    }
    ...
    @Test
    void serializationNumberShouldBeThree() {
        assertEquals(3, serialization.getSerializationNumber());
    }
