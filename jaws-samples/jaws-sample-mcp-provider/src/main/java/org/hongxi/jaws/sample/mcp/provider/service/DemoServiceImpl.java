...
/**
 * DemoService implementation exposed as MCP tools via the {@code mcp} protocol.
 */
public class DemoServiceImpl implements DemoService {
    ...
    public void save(Contacts contacts) {
        System.out.println("Saved contacts: " + contacts);
    }

    @Override
    public int save(List<Contacts> contactsList) {
        System.out.println("Saved contacts list: " + contactsList);
