package org.hongxi.jaws.sample.http2.consumer;
...
public class Http2Consumer {
    ...
    public static void main(String[] args) {
        ...
        demoRef.setApplication("sample-http2-consumer");
        demoRef.setModule("sample-http2");
        ...
        orderRef.setApplication("sample-http2-consumer");
        orderRef.setModule("sample-http2");
