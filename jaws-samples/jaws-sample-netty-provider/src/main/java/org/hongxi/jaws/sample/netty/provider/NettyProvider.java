package org.hongxi.jaws.sample.netty.provider;
...
import org.hongxi.jaws.sample.netty.provider.service.DemoServiceImpl;
import org.hongxi.jaws.sample.netty.provider.service.OrderServiceImpl;

/**
 * Netty transport provider - no registry dependency.
 *
 * <pre>
 * Demo scenario:
...
public class NettyProvider {
    ...
    public static void main(String[] args) {
        ...
        demoServiceConfig.setApplication("sample-netty-provider");
        demoServiceConfig.setModule("sample-netty");
        ...
        orderServiceConfig.setApplication("sample-netty-provider");
        orderServiceConfig.setModule("sample-netty");
