...
/**
 * DemoService implementation for the harbor provider sample.
 */
public class DemoServiceImpl implements DemoService {

    @Override
    public String hello(String name) {
        return "Hello, " + name + " (from harbor-provider)";
    }
    ...
    public CompletableFuture<String> helloAsync(String name) {
        return CompletableFuture.supplyAsync(() -> "Hello async, " + name + " (from harbor-provider)");
    }
