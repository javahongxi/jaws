package org.hongxi.jaws.sample.provider.stream;

import org.hongxi.jaws.common.JawsConstants;
import org.hongxi.jaws.config.ProtocolConfig;
import org.hongxi.jaws.config.ServiceConfig;
import org.hongxi.jaws.sample.api.StreamService;
import org.hongxi.jaws.sample.provider.stream.service.StreamServiceImpl;
 ...
 * </pre>
 *
 * <p>Run with: {@code java -Dtransport=http2 -Dport=10002 StreamProvider}
 */
public class StreamProvider {
    ...
    public static void main(String[] args) {
        ...
        streamServiceConfig.setApplication("sample-provider-stream");
