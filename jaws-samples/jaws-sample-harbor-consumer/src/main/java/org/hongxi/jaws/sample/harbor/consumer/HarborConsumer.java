...
/**
 * Service consumer that discovers services from the embedded HarborServer
 * started by {@code HarborProvider}.
 *
 * <pre>
 * Demo scenarios:
 * 1. Nacos registry pointing to the embedded HarborServer (port 19848)
