package org.hongxi.jaws.sample.netty.consumer;
 ...
 * </pre>
 *
 * <p>Run {@code NettyProvider} first before starting this consumer.
 */
public class NettyConsumer {
    ...
    public static void main(String[] args) {
        ...
        demoRef.setApplication("sample-netty-consumer");
        demoRef.setModule("sample-netty");
        ...
        orderRef.setApplication("sample-netty-consumer");
        orderRef.setModule("sample-netty");
