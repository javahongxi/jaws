...
public interface ServerReflectionRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:grpc.reflection.v1.ServerReflectionRequest)
   ...
   */
  org.hongxi.jaws.wire.reflection.ExtensionRequest getFileContainingExtension();
  /**
   * <pre>
   * Find the proto file which defines an extension extending the given
   * message type with the given field number.
   ...
   * <code>.grpc.reflection.v1.ExtensionRequest file_containing_extension = 5;</code>
   */
  org.hongxi.jaws.wire.reflection.ExtensionRequestOrBuilder getFileContainingExtensionOrBuilder();
  ...
  org.hongxi.jaws.wire.reflection.ServerReflectionRequest.MessageRequestCase getMessageRequestCase();
}
